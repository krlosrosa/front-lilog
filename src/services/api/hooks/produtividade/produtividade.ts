...
/**
 * @summary Inicia um picking
 */
export const produtividadeControllerIniciarProdutividade = (
    centerId: string,
...
export const getProdutividadeControllerIniciarProdutividadeMutationOptions = <TError = ErrorType<null>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof produtividadeControllerIniciarProdutividade>>, TError,{centerId: string;data: BodyType<CreateProdutividadeDto>}, TContext>, request?: SecondParameter<typeof axiosFetcher>}
): UseMutationOptions<Awaited<ReturnType<typeof produtividadeControllerIniciarProdutividade>>, TError,{centerId: string;data: BodyType<CreateProdutividadeDto>}, TContext> => {

const mutationKey = ['produtividadeControllerIniciarProdutividade'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof produtividadeControllerIniciarProdutividade>>, {centerId: string;data: BodyType<CreateProdutividadeDto>}> = (props) => {
          const {centerId,data} = props ?? {};

          return  produtividadeControllerIniciarProdutividade(centerId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ProdutividadeControllerIniciarProdutividadeMutationResult = NonNullable<Awaited<ReturnType<typeof produtividadeControllerIniciarProdutividade>>>
    export type ProdutividadeControllerIniciarProdutividadeMutationBody = BodyType<CreateProdutividadeDto>
    export type ProdutividadeControllerIniciarProdutividadeMutationError = ErrorType<null>

    /**
 * @summary Inicia um picking
 */
export const useProdutividadeControllerIniciarProdutividade = <TError = ErrorType<null>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof produtividadeControllerIniciarProdutividade>>, TError,{centerId: string;data: BodyType<CreateProdutividadeDto>}, TContext>, request?: SecondParameter<typeof axiosFetcher>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof produtividadeControllerIniciarProdutividade>>,
        TError,
        {centerId: string;data: BodyType<CreateProdutividadeDto>},
        TContext
      > => {

      const mutationOptions = getProdutividadeControllerIniciarProdutividadeMutationOptions(options);
