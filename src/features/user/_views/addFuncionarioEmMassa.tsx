...
import { useCriarFuncionariosEmMassa, useListarFuncionariosPorCentro } from "@/services/api/hooks/usuario/usuario";
import { useQueryClient } from "@tanstack/react-query";
import { toast } from "react-toastify";
import { Upload, FileSpreadsheet, X } from "lucide-react";
import { convertXlsxToArray } from "@/_core/services/convertXlsxToArray";
...
export function AddFuncionarioEmMassa() {
  ...
  const { mutate: addFuncionarioEmMassa, isPending } = useCriarFuncionariosEmMassa(createMutationOptions({
