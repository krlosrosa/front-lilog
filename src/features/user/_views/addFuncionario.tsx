...
import { useCriarNovoFuncionario } from "@/services/api/hooks/usuario/usuario";
import { criarNovoFuncionarioBody } from "@/services/api/schema/usuario/usuario.zod"
...
export function AddFuncionario({ children }: { children: React.ReactNode }) {
  ...
  const { mutate: addFuncionario } = useCriarNovoFuncionario(createMutationOptions({
