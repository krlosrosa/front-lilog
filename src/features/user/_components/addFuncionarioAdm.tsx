...
import { useCriarFuncionarioAdm } from "@/services/api/hooks/usuario/usuario"
import { criarFuncionarioAdmBody } from "@/services/api/schema/usuario/usuario.zod";
...
export function AddFuncionarioAdm() {
  const {mutate: addFuncionarioAdm, isPending} = useCriarFuncionarioAdm( createMutationOptions({
