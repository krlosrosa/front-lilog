...
import { BuscarProdutividadeQuery } from "@/services/graphql/produtividade/getProdutividade.graphql";
import { formatTime } from "@/_shared/lib/formatTime";
...
import TimelineDemandaModal from "../timeline/timelineDemandaModal";
...
export function CardProdutividade({ produtividade }: CardProdutividadeProps) {
  ...
  return (
    <TimelineDemandaModal
      ...
      triggerText="Abrir Timeline da Demanda"
